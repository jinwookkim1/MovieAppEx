        ...
        return(
            <View style={styles.root}>
               ...
               <View style={styles.content}>
                    ...
                    {/* 1.2.1 이메일 선택일때 입력창1개더 추가 */}
                    {
                        // if(this.state.tabIndex===1) error
                    ...
                    {
                        this.state.tabIndex===1 && <View style={{width:'100%', margin:16}}><Button title="다음" onPress={()=>this.props.navigation.goBack()}></Button></View>
                    }
